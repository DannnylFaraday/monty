...
void store(stack_t **head, unsigned int number);
void f_pall(stack_t **head, unsigned int number);
void print_int(stack_t **head, unsigned int number);
int execute(char *content, stack_t **head, unsigned int counter, FILE *file);
void unload_stack(stack_t *head);
void take_out(stack_t **head, unsigned int counter);
void swap_func(stack_t **head, unsigned int counter);
void add_func(stack_t **head, unsigned int counter);
void void_func(stack_t **head, unsigned int counter);
...
void show_text(stack_t **head, unsigned int counter);
void cycle_top(stack_t **head, unsigned int counter);
void cycle_down(stack_t **head, __attribute__((unused)) unsigned int counter);
void insertNode(stack_t **head, int n);
void queue_up(stack_t **head, int n);
